            ...
            <div className="flex flex-col items-center min-h-[200px]">
                ...
                >Ecomstore Wallet</h1>
                {
                    walletDetails && walletDetails?.isActive
                        ?
                        <div
                            className="flex items-center justify-center w-[60%] text-xl uppercase text-green-600 px-3 mt-3 bg-white tracking-wide pt-3 pb-2 border border-green-500 rounded"
                        >
                        ...
                        <button
                            type="button"
                            className={`w-[60%] text-xl uppercase bg-red-500 text-white px-3 rounded mt-3 tracking-wide ${isActivatingWallet ? "pt-2 b-1" : "pt-3 pb-2"}`}
                ...
                <div
                    className={`flex justify-between mt-7 w-[60%] bg-white px-7 py-10 shadow-md rounded ${!walletDetails?.isActive && "blur-sm pointer-events-none opacity-50"}`}
                >
                    <div className="w-1/2">
