...
export default function BasicDetailsContainer({fetchDetailsOfUser, fetchUserDetails } : { 
    ...
    return (
        <div 
            className={`w-1/3 max-lg:w-[75%] max-md:w-[80%] max-sm:w-full max-lg:mb-5 shadow-sm border-gray-100 border rounded-sm p-10 ${!isUploadingProfileImage ? "h-[430px]" : "lg:h-[560px]"}`}
        >
